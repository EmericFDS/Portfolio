...
class CanvasParticleEngine {
    ...
    createParticles() {
        ...
        for (let i = 0; i < this.numParticles; i++) {
            ...
            this.particles.push({
                ...
                baseAlpha: baseAlpha,
                color: colorPrefix,
                // Bolt Perf Optimization: Pre-compute fillStyle and shadowColor to avoid per-frame string concatenation and searching in animation loop (60fps)
    ...
    render() {
        ...
        // Bolt Perf Optimization: Lift loop invariants outside of particle rendering loops
        ...
        const isStretched = stretch > 0.6 && !this.prefersReducedMotion;
